package com.kaio.agendadortarefas.infrastructure.security;
...
public class SecurityConfig {
    ...
    // adicionei o Impl AULA: Consumindo outro Microsserviço
    private final UserDetailsServiceImpl userDetailsService;

    // Construtor para injeção de dependências de JwtUtil e UserDetailsService
    @Autowired                              // adicionei o Impl AULA: Consumindo outro Microsserviço
